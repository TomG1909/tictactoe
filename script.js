...
function checkForWin() {
    ...
    if (winner) {
        ...
        setTimeout(function() {
            ...
            document.getElementById('div-gameover').classList.add('bg-dark');
            document.getElementById('btn').classList.remove('d-none');
            document.getElementById('btn-pos').classList.add('d-flex');
...
function restart() {
    ...
    document.getElementById('div-gameover').classList.remove('bg-dark');
